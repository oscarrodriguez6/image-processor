...
public class CrearPasoDTO {
	...
	public CrearPasoDTO(Long viaje_id, String nombre, String descripcion, LocalDateTime fecha, Point ubicacion,
			String pais, String continente, String poi, List<Long> imagenesIds) {
		super();
